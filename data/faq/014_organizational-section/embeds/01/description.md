...
- Double Counter (<@703886990948565003>) - account verification
- Carl-bot (<@235148962103951360>) - reaction roles on <#909039228904689675>, custom commands (which can be listed by texting !cc on appropriate threads in <#1389709259708563556>)
- YAGPDB.xyz (<@204255221017214977>) - leveling system, moderating ⁠<#909041207341113344>
- Starboard (<@655390915325591629>) - displaying the most valued messages in the <#1230099437423038535> channel
- Tatsu (<@172002275412279296>) - fun, economy
- NotSoBot (<@439205512425504771>) - fun, searching and manipulating images
- FreeStuff (<@672822334641537041>) - posting information about free games in the <#1399338757534257284> thread
- DISBOARD (<@302050872383242240>) - keeping an invite to this server on the [disboard.org](<https://disboard.org/>) list
- Sapphire (<@678344927997853742>) - event log, welcome messages
